...
public class DisponibiliteFormController {
    ...
    // âœ… Spinners au lieu de TextFields
    ...
    public void initialize() {
        ...
        if (EditState.disponibiliteToEdit != null) {
            titleLabel.setText("âœï¸ Modifier DisponibilitÃ©");
            saveButton.setText("ðŸ’¾ Modifier");
    ...
    private void onSave(ActionEvent event) {
        try {
            ...
            // âœ… Lire les heures depuis les Spinners
            ...
            if (!endTime.isAfter(startTime)) {
                showError("L'heure de fin doit Ãªtre aprÃ¨s l'heure de dÃ©but.");
                return;
            }
            ...
            if (EditState.disponibiliteToEdit != null) {
                ...
                showInfo("âœ… DisponibilitÃ© modifiÃ©e !");
                EditState.disponibiliteToEdit = null;
            } else {
                service.add(dispo);
                showInfo("âœ… DisponibilitÃ© ajoutÃ©e !");
            }

            clearForm();
            ViewNavigator.goTo(event, "/DisponibiliteList.fxml", "Mes DisponibilitÃ©s");
